...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        X = std::vector<vector_d>(I,vector_d(static_cast<Eigen::VectorXd::Index>(p)));
        ...
        BS = matrix_d(static_cast<Eigen::VectorXd::Index>(N),static_cast<Eigen::VectorXd::Index>(Kt));
        ...
        validate_non_negative_index("PenMat", "Kt", Kt);
        PenMat = matrix_d(static_cast<Eigen::VectorXd::Index>(Kt),static_cast<Eigen::VectorXd::Index>(Kt));
        ...
        mu_beta = vector_d(static_cast<Eigen::VectorXd::Index>(Kt));
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        matrix_d beta(static_cast<Eigen::VectorXd::Index>(p),static_cast<Eigen::VectorXd::Index>(Kt));
        ...
        matrix_d beta_psi(static_cast<Eigen::VectorXd::Index>(Kp),static_cast<Eigen::VectorXd::Index>(Kt));
        for (int j2__ = 0U; j2__ < Kt; ++j2__)
        ...
        std::vector<vector_d> c(I,vector_d(static_cast<Eigen::VectorXd::Index>(Kp)));
        for (int j1__ = 0U; j1__ < Kp; ++j1__)
        ...
        vector_d beta_sig(static_cast<Eigen::VectorXd::Index>(p));
        for (int j1__ = 0U; j1__ < p; ++j1__)
        ...
        vector_d psi_sig(static_cast<Eigen::VectorXd::Index>(Kp));
        for (int j1__ = 0U; j1__ < Kp; ++j1__)
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        Eigen::Matrix<T__,Eigen::Dynamic,1>  beta_tau2(static_cast<Eigen::VectorXd::Index>(p));
        (void) beta_tau2;  // dummy to suppress unused var warning
        Eigen::Matrix<T__,Eigen::Dynamic,1>  psi_tau2(static_cast<Eigen::VectorXd::Index>(Kp));
    ...
    void write_array(RNG& base_rng__,
        ...
        vector_d beta_tau2(static_cast<Eigen::VectorXd::Index>(p));
        (void) beta_tau2;  // dummy to suppress unused var warning
        vector_d psi_tau2(static_cast<Eigen::VectorXd::Index>(Kp));
        (void) psi_tau2;  // dummy to suppress unused var warning
